...
class Chauffeur(models.Model):
    ...
    date_naissance = models.DateField(max_length=100, null=True, blank=True, verbose_name="Nom du chauffeur")
...
class Client(models.Model):
    ...
    date_naissance = models.DateField(max_length=100, null=True, blank=True, verbose_name="Nom du Client")
    telephone = models.CharField(max_length=100, null=True, blank=True, verbose_name="Numero de telephone")
    adresse = models.CharField(max_length=100, null=True, blank=True, verbose_name="Adresse")    
    email = models.CharField(max_length=100, null=True, blank=True, verbose_name="Email")
...
class Livreur(models.Model):
    ...
    date_naissance = models.DateField(max_length=100, null=True, blank=True, verbose_name="Nom du Livreur")
    telephone = models.CharField(max_length=100, null=True, blank=True, verbose_name="Numero de telephone")
    adresse = models.CharField(max_length=100, null=True, blank=True, verbose_name="Adresse")    
    email = models.CharField(max_length=100, null=True, blank=True, verbose_name="Email")
